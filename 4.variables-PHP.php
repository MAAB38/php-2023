...
# Los nombres de variables no pueden llevar espacios, empezar por numeros o llevar caracteres especiales como puntos o incluso la letra ¤ o ‡
...
/* 
1¦ Funci¢n gettype()
Para conocer el tipo de dato de una variable utilizamos la funci¢n gettype()
*/
